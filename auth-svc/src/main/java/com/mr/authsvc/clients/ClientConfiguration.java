        ...
        clientRepository
            ...
            .map(
                client -> {
                  ...
                  // All requested scopes are conferrered just by authenticating
                  // details.setAutoApproveScopes(
                  // Arrays.asList(client.getAutoApproveScopes().split(",")));

                  String greetingsClientRedirectUri =
                      Optional.ofNullable(this.loadBalancerClient.choose("money-ck-svc-client"))
                  ...
                  details.setRegisteredRedirectUri(
                      Collections.singleton(greetingsClientRedirectUri));
